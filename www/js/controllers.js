...
.controller('SindiCtrl', function($rootScope,$scope) {
	...
	$rootScope.htmlwhatsapp1 	= encodeURIComponent('<a class="crunchify-link crunchify-whatsapp" href="whatsapp://send?text=http://lrwebtool.com/celebridades/?id=sp1ke77" data-action="share/whatsapp/share target="_blank">WhatsApp</a>');
