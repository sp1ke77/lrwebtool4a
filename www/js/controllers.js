angular.module('starter.controllers', ['ngSanitize','720kb.socialshare','ionic'])
...
.controller('SindiCtrl', function($rootScope, $scope, $filter,$ionicPopup, $timeout) {
...
$scope.showPopup = function() {
  ...
  var myPopup = $ionicPopup.show({
    template: '<a class="crunchify-link crunchify-facebook" href="https://www.facebook.com/sharer/sharer.php?u=http://lrwebtool.com/'+$rootScope.slug6+'/?id='+$rootScope.username+'" >Facebook</a>',
