...
.controller('SindiCtrl', function($rootScope, $scope, $filter) {
	...
	$rootScope.htmlfacebook1 	= '<button class="crunchify-link crunchify-facebook  btn btn-medium font-bold" socialshare socialshare-provider="facebook" socialshare-type="feed" socialshare-via="328481047490615"  socialshare-media="http://720kb.net/assets/img/720kb-fb.png" socialshare-text="720kb"  socialshare-caption="720kb is enough" socialshare-url="http://720kb.net"   socialshare-redirect-uri="http://lrwebtool.com/close.html/"  socialshare-popup-height="300"     socialshare-popup-width="400"    socialshare-trigger="click">   <i class="fa fa-facebook"></i> Share on Facebook (feed dialog) </button>';
